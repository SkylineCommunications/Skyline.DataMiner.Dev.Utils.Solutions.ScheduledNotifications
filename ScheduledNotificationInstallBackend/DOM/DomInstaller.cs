	...
	public partial class DomInstaller
	{
		...
		private void InstallNotificationSection(DomHelper helper)
		{
			var section = new SectionDefinitionBuilder()
				...
				.AddFieldDescriptor(new GenericEnumFieldDescriptorBuilder()
					...
					.AddEnumValue(new GenericEnumEntry<int>("Daily", 0))
					.AddEnumValue(new GenericEnumEntry<int>("Weekly", 1))
					.AddEnumValue(new GenericEnumEntry<int>("Monthly", 2)))
				.AddFieldDescriptor(new FieldDescriptorBuilder()
		...
		private void InstallTemplateSection(DomHelper helper)
		{
			var section = new SectionDefinitionBuilder()
				...
				.AddFieldDescriptor(new FieldDescriptorBuilder()
					.WithID(TemplateDomMapper.TemplateProperties.DashboardFilePath)
					.WithName(nameof(TemplateDomMapper.TemplateProperties.DashboardFilePath))
					.WithType(typeof(string))
					.WithIsOptional(false)
					.WithTooltip("File path of the Dashboard template."))
				.AddFieldDescriptor(new FieldDescriptorBuilder()
