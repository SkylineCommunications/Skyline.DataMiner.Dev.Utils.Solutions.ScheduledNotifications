...
01. 07. 2026	1.0.0.1		DSA, Skyline	Initial version
****************************************************************************
*/
...
internal class Script
{
	...
	public void Install(IEngine engine, AppInstallContext context)
	{
		try
		{
			...
			var domInstaller = new ScheduledNotificationInstallBackend.DOM.DomInstaller(engine.GetUserConnection(), installer.Log);
